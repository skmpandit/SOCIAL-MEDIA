...
const Account = () => {
    ...
    const accoutDeleteHandler = async() => {
    ...
    },[error, likeError, message, dispatch, alert]);
  return (
    loading === true || userLoading === true ? (<Loader/>) : (
        <div className='account'> 
            ...
            <div className="accountright">
                ...
                <Button onClick={accoutDeleteHandler} disabled={deleteLoading} variant='text' style={{ color: "red", margin: "2vmax"}} >Delete My Profile</Button>
                    ...
                    <div className="DialogBox">
                        <Typography variant='h4'>Followers</Typography>
                        {
                            user && user.followers.length > 0 ? (user.followers.map((follower) => (
                                ...
                                <Typography style={{ margin: "2vmax"}} variant='h8'>You have no followers</Typography>
                            )
                        }
                    </div>
                </Dialog>
